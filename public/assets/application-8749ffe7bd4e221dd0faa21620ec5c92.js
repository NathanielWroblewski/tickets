...
(function() {
  $(function() {
    ...
    $('.reveal-add-itinerary').on('click', function() {
      $('.revealed-add-itinerary').fadeIn();
      return $(this).hide();
    });
    $('.add-new-ticket').on('submit', function(e) {
      var description, itinerary_id, location, title;
      e.preventDefault();
      if ($(this).find('.add-new-ticket-location').val().length > 0) {
        $('.revealed-add-itinerary').hide();
        ...
        return $.ajax({
          ...
          $('.my-itinerary').append("<div class='col-xs-12 itinerary-item text-center          '> " + data.title + " " + data.location + "</div>");
          return $('.reveal-add-itinerary').fadeIn();
        });
      }
    });
    return $('.add-new-ticket-mobile').on('submit', function(e) {
      var description, itinerary_id, location, title;
      e.preventDefault();
      if ($('.add-new-ticket-mobile .add-new-ticket-location').val().length > 0) {
        ...
        return $.ajax({
          ...
          $('.mobile-tickets').prepend("<div class='col-xs-12 itinerary-item text-center          '> " + data.title + " " + data.location + "</div>");
          $("#myModal").modal('hide');
          return $(".add-new-ticket-mobile")[0].reset();
        });
      }
    });
  });
